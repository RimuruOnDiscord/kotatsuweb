...
import DesktopTopbar from './desktop/DesktopBrowseTopBar';
...
const AppTopbar: React.FC<AppTopbarProps> = ({ searchQuery, onSearchQueryChange, onSearchSubmit }) => {
  ...
  return (
    <header className="sticky top-0 z-[100] w-full border-b border-white/5 bg-[var(--app-bg)] shadow-[0_18px_40px_-28px_rgba(0,0,0,0.9)]">
      <MobileTopbar
