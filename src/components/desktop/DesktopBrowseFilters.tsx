  ...
  return (
    <div className="hidden xl:flex flex-wrap items-center gap-2.5">
      ...
      <div className="group relative flex min-w-[240px] max-w-[300px] flex-1 items-center">
        ...
        {!props.searchQuery && (
          <div className="pointer-events-none absolute right-4 flex items-center gap-1 rounded border border-white/10 bg-white/[0.02] px-1.5 py-0.5 text-[10px] font-bold text-zinc-600 opacity-0 transition-opacity duration-300 group-focus-within:opacity-100">
            <span>ENTER</span>
          </div>
        )}
      </div>
