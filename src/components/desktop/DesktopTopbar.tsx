    ...
    <div className="mx-auto hidden w-full max-w-[1420px] items-center justify-between gap-6 px-4 py-3 lg:flex">
      ...
      <div className="flex shrink-0 items-center gap-3">
        ...
        <a
          ...
          className="ripple-button h-12 items-center gap-2 rounded-full border border-white/[0.06] bg-[#0d0f11]/98 px-4 text-[10px] font-black uppercase tracking-[0.2em] text-zinc-300 transition-colors hover:text-white md:inline-flex"
        >
          <Github size={15} />
        </a>
      </div>
