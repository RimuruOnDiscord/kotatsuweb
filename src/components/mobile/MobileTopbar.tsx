...
import { Github, Menu, Palette, Search, X } from 'lucide-react';
          ...
          <div className="overflow-hidden rounded-[1.6rem] border border-[var(--app-border)] bg-[var(--app-surface-1)] shadow-[0_22px_48px_-28px_rgba(0,0,0,0.92)]">
            ...
            <div className="border-t border-white/[0.06] p-3">
              ...
              <a
                ...
                rel="noreferrer"
                onMouseDown={handleRippleMouseDown}
                className="ripple-button flex h-12 w-full items-center justify-center gap-2 rounded-[1.1rem] border border-[var(--app-border)] bg-[var(--app-surface-2)] text-[10px] font-black uppercase tracking-[0.2em] text-zinc-300 transition-colors hover:text-white"
              >
                <Github size={15} />
                GitHub
              </a>
