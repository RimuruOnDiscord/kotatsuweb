  ...
  const renderInputBox = (value: string, onChange: (v: string) => void, onSubmit: () => void, isSubmitting: boolean, placeholder: string, autoFocus?: boolean) => {
    ...
    return (
      <div className="flex flex-col sm:flex-row gap-3 w-full">
        <div
          className="flex h-9 w-9 flex-shrink-0 items-center justify-center rounded-full text-xs font-bold text-white hidden sm:flex overflow-hidden"
      ...
      <div className={`mt-3 ${depth > 0 ? 'ml-4 sm:ml-12 border-white/5 pl-4' : ''}`}>
        <div className="group rounded-2xl border border-transparent hover:border-white/5 bg-transparent hover:bg-white/[0.01] p-3 -mx-3 transition-all relative">
          ...
          <div className="flex items-start gap-3">
            <div
              className="flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-full text-[11px] font-bold text-white overflow-hidden"
      ...
      <section className="mt-8 mb-6">
        ...
        >
          <div className="flex items-center gap-3">
            <div className="flex items-center gap-2 text-[10px] font-regular uppercase tracking-[0.24em] text-[var(--app-accent)] hover:text-white">
