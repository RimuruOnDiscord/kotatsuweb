    ...
    return (
      <React.Fragment key={page}>
        ...
        <button
          ...
          className={`inline-flex h-9 sm:h-11 min-w-[36px] sm:min-w-[44px] items-center justify-center rounded-full border px-3 sm:px-4 text-[9px] sm:text-[10px] font-bold uppercase tracking-[0.18em] transition-all duration-300 ${
            currentPage === page 
