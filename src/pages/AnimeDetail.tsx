    ...
    const fetchAll = async () => {
      ...
      try {
        ...
        if (defaultProvider) {
          ...
          // Set to dub if requested later, but default sub
          setCategory('sub');
        }
  ...
  if (loading) {
    return (
      <div className="aw-root min-h-screen flex flex-col p-8 anim-fade-in-up">
        ...
        <button
          onClick={() => navigate(-1)}
          className="group flex items-center gap-2 rounded-full px-5 py-2.5 mb-8 w-fit transition-all duration-300 hover:bg-white/[0.04] active:scale-95 relative z-50"
          style={{ background: 'transparent', border: '1px solid rgba(255, 255, 255, 0.08)', color: 'rgba(255, 255, 255, 0.8)' }}
        >
          <ChevronLeft size={16} className="group-hover:-translate-x-1 transition-transform duration-300" />
          <span style={{ fontFamily: '"Syne", sans-serif', fontSize: '11px', fontWeight: 800, textTransform: 'uppercase', letterSpacing: '0.18em', marginTop: '1px' }}>
            BACK
          </span>
        </button>
  ...
  return (
    <div className="aw-root aw-noise relative min-h-screen text-white pb-20 selection:bg-[var(--aw-accent-muted)]">
      ...
      <div className="relative z-10 mx-auto w-full max-w-[1460px] px-4 pt-8 anim-fade-in-up">
        ...
        <button
          onClick={() => navigate(-1)}
          className="group flex items-center gap-2 rounded-full px-5 py-2.5 mb-8 w-fit transition-all duration-300 hover:bg-white/[0.04] active:scale-95"
          style={{ background: 'transparent', border: '1px solid rgba(255, 255, 255, 0.08)', color: 'rgba(255, 255, 255, 0.8)' }}
        >
          <ChevronLeft size={16} className="group-hover:-translate-x-1 transition-transform duration-300" />
          <span style={{ fontFamily: '"Syne", sans-serif', fontSize: '11px', fontWeight: 800, textTransform: 'uppercase', letterSpacing: '0.18em', marginTop: '1px' }}>
        ...
        <div className="grid lg:grid-cols-[1fr_320px] gap-12">
          ...
          <div className="space-y-10 min-w-0">
            <div className="flex flex-col min-w-0">
              ...
              {/* Seasons Navigation Pill Tabs - RESTORED TO TOP */}
              {navTabs.length > 1 && (
                <div className="mb-10">
