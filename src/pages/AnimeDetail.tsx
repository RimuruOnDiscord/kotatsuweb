...
import {
  ChevronLeft, ChevronRight, Star, Loader2, Bookmark, BookmarkCheck, Languages,
...
const AnimeDetail: React.FC = () => {
  ...
  if (loading) {
    return (
      <div className="aw-root min-h-screen flex items-center justify-center anim-fade-in-up">
  ...
  if (!data || loadFailed) {
    return (
      <div className="aw-root aw-noise min-h-screen flex flex-col items-center justify-center gap-5 px-4 text-center anim-fade-in-up">
        <div className="text-xl font-bold uppercase tracking-[0.16em] error-shake" style={{ fontFamily: 'var(--aw-font-display)' }}>
  ...
  return (
    <div className="aw-root aw-noise relative min-h-screen text-white pb-20 selection:bg-[var(--aw-accent-muted)]">
      ...
      <div className="relative z-10 mx-auto w-full max-w-[1460px] px-4 pt-8 anim-fade-in-up">
        <button
          onClick={() => navigate(-1)}
          className="group back-btn flex items-center gap-2 rounded-full border px-4 py-2 mb-8 w-fit press-squish"
              ...
              {watchProgress ? (
                <>
                  ...
                  <div className={`flex items-center rounded-[14px] overflow-hidden border transition-all ${!providerEpisodes.length ? 'opacity-40 pointer-events-none' : ''}`} style={{ borderColor: 'var(--aw-border)' }}>
                    <button onClick={handleWatchFirst} disabled={!providerEpisodes.length || isLinking} className="aw-btn-ghost group relative overflow-hidden press-squish flex h-[48px] items-center justify-center px-5 text-sm font-bold" style={{ background: 'var(--aw-s1)', color: 'white', fontFamily: 'var(--aw-font-display)', textTransform: 'uppercase', letterSpacing: '0.05em' }}>
                ...
                <div className={`flex items-center rounded-[14px] overflow-hidden transition-all ${!providerEpisodes.length ? 'opacity-40 pointer-events-none' : ''}`}>
                  <button onClick={handleWatchFirst} disabled={!providerEpisodes.length || isLinking} className="aw-btn-primary group relative overflow-hidden press-squish flex h-[48px] items-center justify-center border px-6 text-sm font-bold disabled:opacity-60" style={{ background: 'var(--aw-accent-dim)', color: 'var(--aw-accent)', borderColor: 'var(--aw-accent)', fontFamily: 'var(--aw-font-display)', textTransform: 'uppercase', letterSpacing: '0.05em', borderTopLeftRadius: '14px', borderBottomLeftRadius: '14px' }}>
                    <div className="absolute inset-0 bg-white/25 translate-x-[-120%] skew-x-[-20deg] transition-transform duration-500 group-hover:translate-x-[120%]" />
                    <span className="relative z-10 flex items-center gap-2">
                  ...
                  <button onClick={handleWatchLatest} disabled={!providerEpisodes.length || isLinking} className="aw-btn-ghost group relative overflow-hidden press-squish flex h-[48px] items-center justify-center border-t border-b border-r px-6 text-sm font-bold disabled:opacity-60" style={{ background: 'var(--aw-s1)', color: 'white', borderColor: 'var(--aw-border)', fontFamily: 'var(--aw-font-display)', textTransform: 'uppercase', letterSpacing: '0.05em', borderTopRightRadius: '14px', borderBottomRightRadius: '14px' }}>
                    <div className="absolute inset-0 bg-white/25 translate-x-[-120%] skew-x-[-20deg] transition-transform duration-500 group-hover:translate-x-[120%]" />
                    <span className="relative z-10 flex items-center gap-2">
                      <Tv size={15} />
...
<button
  ...
  style={{ 
    ...
    // Apply the bouncy transition from your CSS
    transition: 'all 0.4s cubic-bezier(0.34, 1.56, 0.64, 1)'
  }}
  ...
  `}
  // Use inline style for the complex color-mix hover
  onMouseEnter={(e) => {
                  ...
                  <div className="flex flex-wrap items-center gap-2">
                    {providerNames.map((providerName) => (
                      <button
                        ...
                        className="pill-tab rounded-full border px-4 py-2 text-[10px] font-bold uppercase tracking-[0.18em]"
