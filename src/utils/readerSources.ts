...
export const READER_SOURCE_DEFINITIONS: ReaderSourceDefinition[] = [
  { key: 'mangapill', label: 'Mangapill', implemented: true },
  { key: 'asurascans', label: 'AsuraScans', implemented: true },
  { key: 'mangakakalot', label: 'Mangakakalot', implemented: false },
  { key: 'manganato', label: 'Manganato', implemented: false },
  { key: 'batoto', label: 'Bato.to', implemented: false },
  { key: 'webtoon', label: 'Webtoon', implemented: false },
];
